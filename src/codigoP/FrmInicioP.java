...
public class FrmInicioP extends javax.swing.JFrame {
    ...
    private void btnAnalizarLexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarLexActionPerformed
       int cont = 1;
        ...
        LexerPascal lexer = new LexerPascal(new StringReader(expr));
        String resultado = "LINEA " + cont + "\t\tSIMBOLO\n";
        while (true) {
            TokensPascal token = null;
           try {
               token = lexer.yylex();
           } catch (IOException ex) {
               Logger.getLogger(FrmInicioP.class.getName()).log(Level.SEVERE, null, ex);
           }
            if (token == null) {
            ...
            switch (token) {
                ...
                case Var:
                    ...
                    break;
                case ReadLn:
                    resultado += "  <Reservada ReadLn >\t" + lexer.lexeme + "\n";
                    break;
                case If:
 ...
 String ST = txtResultado.getText();
        SintacticoP s = new SintacticoP(new codigo.LexerCup(new StringReader(ST)));
