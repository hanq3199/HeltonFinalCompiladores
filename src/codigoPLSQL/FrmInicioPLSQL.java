 ...
 * @author jcora
 */
public class FrmInicioPLSQL extends javax.swing.JFrame {

    /**
     * Creates new form FrmPrincipal
     */
    public FrmInicioPLSQL() {
        initComponents();
    }
    ...
    private void btnAnalizarLexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarLexActionPerformed
       int cont = 1;
        ...
        LexerPLSQL lexer = new LexerPLSQL (new StringReader(expr));
        ...
        while (true) {
           ...
           try {
               ...
               Logger.getLogger(FrmInicioPLSQL.class.getName()).log(Level.SEVERE, null, ex);
           }
            if (token == null) {
 ...
 String ST = txtResultado.getText();
        SintacticoPl s = new SintacticoPl (new codigo.LexerCup(new StringReader(ST)));
     ...
     */
    public void correrInterfazPLSQL() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmInicioPLSQL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmInicioPLSQL().setVisible(true);
            }
        });
    }
