 ...
 * @author jcora
 */
public class FrmInicioC extends javax.swing.JFrame {
       ...
       int cont = 1;
        ...
        while (true) {
           ...
           try {
               ...
               Logger.getLogger(FrmInicioC.class.getName()).log(Level.SEVERE, null, ex);
           }
            if (token == null) {
 ...
 String ST = txtResultado.getText();
        SintacticoC s = new SintacticoC(new codigo.LexerCup(new StringReader(ST)));
 ...
 public static void main(String args[]) {
     ...
     public void correrInterfazC() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmInicioC().setVisible(true);
            }
        });
    }
